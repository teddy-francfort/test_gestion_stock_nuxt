<template>
  ...
  <a-form :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }" style="max-width: 800px">
    ...
    <a-form-item label="Confirmation du mot de passe" v-bind="validateInfos.passwordConfirmation">
      <a-input-password id="password_confirmation" v-model:value="modelRef.password_confirmation" />
    </a-form-item>
    <a-form-item :wrapper-col="{ offset: 8, span: 16 }">
      <a-button type="primary" @click.prevent="onSubmit">Créer le compte</a-button>
    </a-form-item>
  </a-form>
</template>
